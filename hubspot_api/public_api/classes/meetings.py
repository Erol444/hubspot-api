...
class Meetings:
    ...
    def add_internal_note(self, meeting_id, note: str):
        ...
        """
        return self.update(meeting_id, { "hs_internal_meeting_notes": to_richtext(note) })